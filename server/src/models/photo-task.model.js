...
module.exports = sequelize.define('PhotoTask', {
  ...
  status: { type: DataTypes.ENUM('PENDING', 'PROCESSING', 'SUCCESS', 'FAILED', 'TIMEOUT'), allowNull: false, defaultValue: 'PENDING' },
  stage_code: { type: DataTypes.STRING(32), allowNull: false, defaultValue: 'received' },
  stage_text: { type: DataTypes.STRING(64), allowNull: false, defaultValue: '已接收照片' },
