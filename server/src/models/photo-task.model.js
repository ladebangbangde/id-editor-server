...
module.exports = sequelize.define('PhotoTask', {
  ...
  original_path: DataTypes.STRING(512),
  preview_path: DataTypes.STRING(512),
  hd_path: DataTypes.STRING(512),
  print_path: DataTypes.STRING(512),
  openid_hash: DataTypes.STRING(64),
  retain_until: DataTypes.DATE,
  deleted_at: DataTypes.DATE,
  physical_deleted_at: DataTypes.DATE,
  purged_at: DataTypes.DATE,
  cleanup_status: { type: DataTypes.STRING(32), allowNull: false, defaultValue: 'pending' },
  cleanup_error: DataTypes.STRING(1000),
  file_expire_at: DataTypes.DATE,
